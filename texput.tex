...
\svgfig{graphics/compresion_entropica}{6cm}{600}
...
\svgfig{graphics/prob_vs_long}{6cm}{600}
...
\svgfig{graphics/universal_coding_example}{4cm}{400}
...
\section{\mylink{probabilistic_models}{Probabilistic models}}
\section{\mylink{Shannon-Fano_coding}{Shannon-Fano coding}}
\section{\mylink{Huffman_coding}{Huffman coding}}
\section{\mylink{arithmetic_coding}{Arithmetic coding}}
\section{\mylink{move-to-front_transform}{Move-to-front transform}}
\section{\mylink{context-based_text_predictive_transform}{Context-base text predictive transform}}
\section{\mylink{unary_coding}{Unary coding}}
\section{\mylink{Golomb-Rice_coding}{Golomb-Rice coding}}
\section{\mylink{gzip}{gzip}}
